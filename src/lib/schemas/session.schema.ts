...
export const AdaptationSessionSchema = z.object({
  ...
  jobText: z.string(),
  parsedJob: ParsedJobSchema,
  parsedResume: ParsedResumeSchema,
  score: CompatibilityScoreSchema,
  originalDocument: CvDocumentSchema,
  adaptedDocument: CvDocumentSchema,
  tailoredHtml: z.string(),
  audits: z.array(ResumeChangeAuditSchema),
